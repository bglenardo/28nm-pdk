// ===========================================================================
// sketch_may26_r4_SEL -- MINIMAL PATCH of sketch_may26_r4 (2026-06-09).
//
// ONLY two changes vs the original (marked with "// PATCH" below):
//   1. setup(): the hardcoded configureDevice(1,0,14) + while(true){} trap
//      are replaced by a READY banner.
//   2. loop(): now parses "SEL <flavor> <row> <col>\n" from Serial and calls
//      the EXISTING configureDevice() -- plus "PING" -> "PONG" for a comms
//      check. Nothing else in this file was touched: pin map, timing,
//      scan encoding, shifting, latching, and the verification report are
//      the original working code, byte for byte.
//
